    ...
    <div id="App" className="container-fluid">
      <div className="row">
        ...
        <div id="main-content" className="col-md-8">
          ...
          <div id="editor">
            <InputForm activeRule={activeRule} updateActiveRule={updateActiveRule} socket={socket} customObjects = {customObjects}/>
          </div>
        ...
        <div id="right-sidebar" className="col-md">
          <WarningList socket={socket} addCustomObject = {addCustomObject} customObjects = {customObjects}/>
        </div>
      </div>
    </div>
  );
